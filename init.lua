...
minetest.register_on_joinplayer(function(player)
	...
	if minetest.check_player_privs(player:get_player_name(), {ban=true})==false then
		...
		minetest.show_formspec(player:get_player_name(), "ffa_form", "size[6.5,5] background[1,1;1,1;gui_formbg.png;true] bgcolor[#111111aa; true] image_button[0.7,1.3;2,2;key_logo.png;image;] pwdfield[0.7,4.35;5.8,1;pass;;#cccccc] tooltip[image;Your password: "..num2..";#A500A5;white] label[3,1.9;Hover key\nto reveal password] box[0,0;6.35,0.7;#111111] label[0.3,0.15;"..minetest.colorize("#777777","Server is available for PC users only").."] field_close_on_enter[pass;true]")
...
minetest.register_on_player_receive_fields(function(player, formname, fields)
	if formname == "ffa_form" then
		...
		if fields.pass and not fields.image then
